...
func InitTracing(zipkinURL string, serviceName string) {
	...
	logrus.Info("Span Url:", spanUrl)
	reporter := zipkinhttpreporter.NewReporter(
		spanUrl,
		zipkinhttpreporter.RequestCallback(func (r *http.Request) {
			logrus.Info(r.Method, r.URL, r.ContentLength)
		}),)
	...
	ServerMiddleware = zipkinhttp.NewServerMiddleware(
		nativeTracer, zipkinhttp.TagResponseSize(true),
	)
