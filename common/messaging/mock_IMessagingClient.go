...
// MockIMessagingClient is an autogenerated mock type for the IMessagingClient type
type MockIMessagingClient struct {
	mock.Mock
}

// Close provides a mock function with given fields:
func (_m *MockIMessagingClient) Close() {
	_m.Called()
}

// ConnectToBroker provides a mock function with given fields: connectionString
func (_m *MockIMessagingClient) ConnectToBroker(connectionString string) {
	_m.Called(connectionString)
}

// Publish provides a mock function with given fields: msg, exchangeName, exchangeType
func (_m *MockIMessagingClient) Publish(msg []byte, exchangeName string, exchangeType string) error {
...
func (_m *MockIMessagingClient) PublishOnQueue(msg []byte, queueName string) error {
...
func (_m *MockIMessagingClient) Subscribe(exchangeName string, exchangeType string, consumerName string, handlerFunc func(amqp.Delivery)) error {
...
func (_m *MockIMessagingClient) SubscribeToQueue(queueName string, consumerName string, handlerFunc func(amqp.Delivery)) error {
