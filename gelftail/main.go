...
import (
	...
	"github.com/PanYicheng/go-microservice/gelftail/aggregator"
	"github.com/PanYicheng/go-microservice/gelftail/transformer"
...
func init() {
	...
	authToken = strings.TrimSuffix(string(data), "\n")
	logrus.Infof("authToken: %s", authToken)
